...
Rules for our variation of this game are:
...
While there are other variations of this game online, in our version we want each player to have one turn per round, and the rounds keep repeating until everyone has either stopped rolling or gone bust. 
